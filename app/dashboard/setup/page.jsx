  ...
  return (
    <div className="py-5 pr-4">
      ...
      <div className="m-8 grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <SetupCard icon={<UserIcon />} description="User" href="/dashboard/user"/>
        <SetupCard icon={<ShopIcon />} description="Shop" href="/dashboard/shop"/>
        <SetupCard icon={<CategoryIcon />} description="Category" href="/dashboard/category"/>
        <SetupCard icon={<ProductIcon />} description="Item" href="/dashboard/item"/>
        <SetupCard icon={<TableIcon />} description="Table" href="/dashboard/table"/>
      </div>
    </div>
  );
};
...
function SetupCard({ icon, description = "tooltip 💡", href = "/" }) {
  return (
    <a href={href}>
      <div className="flex pt-5 bg-white rounded-lg overflow-hidden shadow-md w-full  items-center p-4 justify-start" style={{"gap": "0.75rem"}}>
        {/* Icon */}
        <div className="group ">
          {icon}
        </div>
...
function CategoryIcon() {
  return (
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><path fill="black" d="m12 2l-5.5 9h11L12 2zm0 3.84L13.93 9h-3.87L12 5.84zM17.5 13c-2.49 0-4.5 2.01-4.5 4.5s2.01 4.5 4.5 4.5s4.5-2.01 4.5-4.5s-2.01-4.5-4.5-4.5zm0 7a2.5 2.5 0 0 1 0-5a2.5 2.5 0 0 1 0 5zM3 21.5h8v-8H3v8zm2-6h4v4H5v-4z" style={{"width": "2.5rem"}}/></svg>
    </div>
  );
}
...
function UserIcon() {
  return (
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 256 256"><rect x="0" y="0" width="256" height="256" fill="none" stroke="none" /><path fill="black" d="M230.92 212c-15.23-26.33-38.7-45.21-66.09-54.16a72 72 0 1 0-73.66 0c-27.39 8.94-50.86 27.82-66.09 54.16a8 8 0 1 0 13.85 8c18.84-32.56 52.14-52 89.07-52s70.23 19.44 89.07 52a8 8 0 1 0 13.85-8ZM72 96a56 56 0 1 1 56 56a56.06 56.06 0 0 1-56-56Z" style={{"width": "2.5rem"}}/></svg>
    </div>
  );
}
