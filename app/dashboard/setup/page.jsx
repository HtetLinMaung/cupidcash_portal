...
const Setup = () => {
  return (
    <div className="py-5 pr-4">
      ...
      <div className="m-8 grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-6">
...
function SetupCard({ icon, description = "tooltip 💡", href = "/" }) {
  return (
    <a href={href}>
      <div className="flex pt-5 bg-white rounded-lg overflow-hidden shadow-md w-full">
        {/* Icon */}
